...
- **Migrations 010-016 can be run again safely.** If an earlier run stopped partway (for example with "already exists"), just run the file once more and it finishes the job.
